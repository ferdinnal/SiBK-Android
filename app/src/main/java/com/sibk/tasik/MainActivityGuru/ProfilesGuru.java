...
import com.sibk.tasik.MainActivitySiswa.RiwayatPelanggaranSiswa;
...
public class ProfilesGuru extends AppCompatActivity {
    ...
    private LinearLayout llPoint, llNISN, llPhoneOrtu, llAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBUser dbUser = new DBUser(ProfilesGuru.this);
        userModel = dbUser.findUser();
        idPengguna = userModel.getuserid();
        idTipePengguna = userModel.getusertypeid();

        website = new Website();
        ss = new ScreenSize(ProfilesGuru.this);

        dialogPlus = DialogPlus.newDialog(ProfilesGuru.this)
    ...
    private void setLayout() {
        ...
        tvKelas.setVisibility(View.GONE);
        llHistoryPelanggaran = (LinearLayout) findViewById(R.id.llHistoryPelanggaran);
        llPoint = (LinearLayout) findViewById(R.id.llPoint);
        llNISN = (LinearLayout) findViewById(R.id.llNISN);
        llPhoneOrtu = (LinearLayout) findViewById(R.id.llPhoneOrtu);
        llAddress = (LinearLayout) findViewById(R.id.llAddress);
        llPoint.setVisibility(View.GONE);
        llNISN.setVisibility(View.GONE);
        llPhoneOrtu.setVisibility(View.GONE);
        llAddress.setVisibility(View.GONE);
        llHistoryPelanggaran.setVisibility(View.GONE);
    ...
    public void setClick() {
        ...
        llHistoryPelanggaran.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ProfilesGuru.this, RiwayatPelanggaranSiswa.class);
                startActivity(i);
            }
        });
...
//                    TransitionManager.beginDelayedTransition(kelompok);
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        JSONObject dataSiswa = result.getJSONObject("data_guru");
                        ...
                        tvPhone.setText("No Guru " + noHandphone);
    ...
    public void alert(final String status, final String message) {
        if (status.equalsIgnoreCase("succes")) {
            SweetAlertDialog pDialog = new SweetAlertDialog(ProfilesGuru.this, SweetAlertDialog.SUCCESS_TYPE);
            ...
            SweetAlertDialog pDialog = new SweetAlertDialog(ProfilesGuru.this, SweetAlertDialog.WARNING_TYPE);
            ...
            SweetAlertDialog pDialog = new SweetAlertDialog(ProfilesGuru.this, SweetAlertDialog.ERROR_TYPE);
    ...
    private void doLogout() {
        DBUser db_user = new DBUser(ProfilesGuru.this);
        db_user.delete();
        Intent i = new Intent(ProfilesGuru.this, LoginActivity.class);
        startActivity(i);
        finish();
    }
