...
public class PelajaranAbsensiAdapter extends BaseAdapter {
    ...
    public PelajaranAbsensiAdapter(final Activity act, List<PelajaranModel> listBank)
    {
        this.act=act;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        cvAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(act, Absensi.class);
