...
public class AbsensiJadwal extends AppCompatActivity {
    ...
    private PelajaranAbsensiAdapter adapterPelajaran;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBUser dbUser = new DBUser(AbsensiJadwal.this);
    ...
    private void getData() {
        ...
        listPelajaran.clear();
        AndroidNetworking.post(AbsensiApi.POST_FIND_PELAJARAN_SISWA)
...
//                    TransitionManager.beginDelayedTransition(kelompok);
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        adapterPelajaran = new PelajaranAbsensiAdapter(AbsensiJadwal.this, listPelajaran);
    ...
    public void alert(final String status, final String message) {
        if (status.equalsIgnoreCase("succes")) {
            SweetAlertDialog pDialog = new SweetAlertDialog(AbsensiJadwal.this, SweetAlertDialog.SUCCESS_TYPE);
            ...
            SweetAlertDialog pDialog = new SweetAlertDialog(AbsensiJadwal.this, SweetAlertDialog.ERROR_TYPE);
